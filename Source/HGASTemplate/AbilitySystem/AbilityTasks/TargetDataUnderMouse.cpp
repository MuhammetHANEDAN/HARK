...
void UTargetDataUnderMouse::Activate()
{
	...
	else
	{
		...
		UKismetSystemLibrary::PrintString(this,FString("gelindi"));
...
void UTargetDataUnderMouse::OnTargetDataReplicatedCallback(const FGameplayAbilityTargetDataHandle& DataHandle,FGameplayTag ActivationTag)
{
	...
	UKismetSystemLibrary::PrintString(this,FString("OnTargetReplicatedcallback worked"));
	if(ShouldBroadcastAbilityTaskDelegates()) 
	{
		UKismetSystemLibrary::PrintString(this,FString("Valid data pin callback will execute"));
		ValidData.Broadcast(DataHandle);
	}
	else
	{
		UKismetSystemLibrary::PrintString(this,FString("ShouldBroadcastAbilityTaskDelegates() = false "));
	}
